//! GTK4 / GLib C FFI bindings for the UI/UX kit.
//!
//! This module provides raw C function declarations and opaque type aliases
//! for GTK4, GDK, and GLib. All widget types are represented as opaque
//! pointers. For type-safe wrappers, see the `widget` module.
...
// (Constants only — GTK_ALIGN_* are defined at the top)
